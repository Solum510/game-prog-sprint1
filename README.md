...
Objectives for sprint 1: 
    ...
    2. For objective 2, I want to shove basically all of the meaty code into methods, so that my code is easier to manage and understand. That way, when the game state changes, I'm not struggling trying to figure out where stuff starts/ends. This is probably not the proper way to make the code easier to understand and more flexible, but this is the first way that popped into my mind. 
